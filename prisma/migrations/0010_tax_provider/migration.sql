...
ALTER TABLE IF EXISTS "Order" ADD COLUMN IF NOT EXISTS "taxProvider" TEXT;
ALTER TABLE IF EXISTS "Order" ADD COLUMN IF NOT EXISTS "taxCalculationId" TEXT;
ALTER TABLE IF EXISTS "Order" ADD COLUMN IF NOT EXISTS "taxSnapshot" JSONB;
