...
ALTER TABLE "VerificationDecision" ALTER COLUMN "outcome" DROP DEFAULT;
...
ALTER TABLE "VerificationDecision" ALTER COLUMN "outcome" TYPE "RuleOutcome" USING "outcome"::text::"RuleOutcome";
