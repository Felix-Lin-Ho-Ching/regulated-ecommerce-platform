    ...
    <header className="sticky top-0 z-30 border-b border-stone-200 bg-white/95 shadow-sm backdrop-blur">
      ...
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3">
        ...
        <nav className="hidden items-center gap-6 text-sm font-black text-slate-700 lg:flex">
          ...
          <Link className="hover:text-teal-900" href="/restricted-products-policy">My State</Link>
        ...
        <div className="ml-auto hidden min-w-0 flex-1 justify-end md:flex">
          <label className="relative w-full max-w-xs">
            ...
            <input className="input py-2 pl-9 text-sm" placeholder="Search products" type="search" />
          </label>
        </div>
        <div className="ml-auto flex shrink-0 items-center gap-2 md:ml-0">
          ...
          <Link className="hidden rounded-full px-2 py-2 text-sm font-bold text-slate-700 hover:bg-stone-100 sm:inline-flex" href="/restricted-products-policy" aria-label="Help">
          ...
          <details className="relative lg:hidden">
            ...
            <div className="absolute right-0 mt-2 grid w-52 gap-2 rounded-2xl border border-stone-200 bg-white p-3 text-sm font-bold shadow-xl">
              ...
              <Link href="/restricted-products-policy">My State</Link>
