...
export const checkoutCases: Record<CheckoutOutcome, { title:string; reason:string; state:string; orderId:string; payment:string; verification:string; fulfillment:string; docs:string[] }> = {
 ...
 ready_for_payment:{title:"Ready for payment",reason:"Eligibility checks passed. Payment has not been collected; fulfillment has not started.",state:"TX",orderId:"SF-1005",payment:"not_collected",verification:"passed",fulfillment:"not_released",docs:[]},
 payment_failed:{title:"Payment was not completed",reason:"Payment was not collected. Eligibility checks remain passed for a future payment step.",state:"TX",orderId:"SF-1006",payment:"not_collected",verification:"passed",fulfillment:"not_released",docs:[]},
 paid:{title:"Future paid order example",reason:"Placeholder for a future payment integration after payment is collected.",state:"TX",orderId:"SF-1007",payment:"future_paid",verification:"passed",fulfillment:"future_release",docs:[]}
};
