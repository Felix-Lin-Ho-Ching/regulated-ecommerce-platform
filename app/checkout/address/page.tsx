...
export default function Address() {
  return (
    <AppShell>
      <SectionHeader eyebrow="Shipping" title="Shipping address and validation">
        Address validation normalizes delivery data before eligibility review.
      </SectionHeader>
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-[1fr_320px]">
        <section className="card p-5">
          ...
          <div className="mt-5">
            <AlertPanel title="Validated address" tone="success">
              USPS-normalized address is deliverable. State TX has a covered rule for
              knuckle_stun_device.
            </AlertPanel>
          </div>
