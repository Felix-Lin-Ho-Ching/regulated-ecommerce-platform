...
if(mode==='lint'){
  ...
  const requiredCheckoutText = ['Card number', 'Expiration date MM/YY', 'Security code', 'Name on card', 'Use shipping address as billing address', 'opaqueData', 'cardSummary'];
